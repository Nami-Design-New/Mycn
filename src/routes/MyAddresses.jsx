            ...
            <div className="address_card">
              <div className="address_header">
                ...
                <div className="menu_container">
                  <button className="menu_btn" onClick={() => toggleMenu(address.id)}>
                    <i className="fas fa-ellipsis-v"></i>
                  </button>
                  {openMenuId === address.id && (
                    <div className="menu_dropdown">
                      <div className="menu_item" onClick={() => handleEditClick(address)}>
                        <i className="fas fa-edit me-2"></i> Edit Address
                      </div>
                      <div className="menu_item" onClick={() => handleDelete(address.id)}>
